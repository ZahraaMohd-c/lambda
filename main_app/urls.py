...
urlpatterns = [
    ...
    path('posts/<int:post_id>/reply/new/', views.ReplyCreateview.as_view(), name='reply_create'),
    path('posts/<int:post_id>/reply/', views.ReplyListView.as_view(), name='post_replies'),
